...
export const STORIES_AVAILABLE_FROM_MODULE: Record<string, ModuleStory[]> = {
  "modulo-1": [
    ...
    {
      title: "La hija de Jairo, y la mujer que tocó el manto de Jesús",
      text: "Marcos 5:21-43",
      verseCount: 23,
    },
    {
    ...
    {
      title: "El ciego Bartimeo recibe la vista",
      text: "Marcos 10:46-52",
      verseCount: 7,
    },
  ],
  "modulo-2": [
  ...
  "modulo-3": [
...

    {
      ...
      text: "Génesis 22:1-19",
      verseCount: 19,
    },
    {
      title: "Las Dos Parteras",
      text: "Exodo 1:15-21",
      verseCount: 7,
    },
    {
      title: "Nacimiento de Moisés",
      text: "Éxodo 1:22 - 2:10",
      verseCount: 11,
    },
    {
    ...
    {
      title: "Jesús Sana al Endemoniado Gadareno",
      text: "Marcos 5:1-20",
      verseCount: 20,
    },
    {
      title: "Jesús, Jairo y la Mujer",
      text: "Marcos 5:21-43",
      verseCount: 23,
    },
    {
    ...
    {
      title: "Jesús le Habla a Nicodemo",
      text: "Juan 3:1-16",
      verseCount: 16,
    },
    {
      title: "Crucifixión y Muerte",
      text: "Lucas 23:33-49",
      verseCount: 17,
    },
